...
ATTENTION! It is huge! With 1GB of data, you have a lot to work with and need to find a way, to use the data smart. Just download and read it into pandas, can be really challenging for your laptops 
